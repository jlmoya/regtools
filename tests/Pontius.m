...
delete('pontius_mat.txt')
diary('pontius_mat.txt')

fprintf('Dataset Pontius, quadratic, solved by regress from Statistics Toolbox\n\n');
fprintf('            min.                   nom.                   max.                    delta\n');
for i=1:length(b)
    fprintf('b(%d)  %22.15e %22.15e %22.15e    %22.15e\n',i,bint(i,1),b(i),bint(i,2),b(i)-bint(i,1));
end
fprintf('\nR2 = %.12f\n',stats(1));

fprintf('\nNIST reference solution: \n'); fprintf('%e\n',Est);

diary off
% linregr(yx,'y x','1 x x.^2','y');        
