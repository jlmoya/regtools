...
//
Est=[0.673565789473684E-03 0.732059160401003E-06 -0.316081871345029E-14]';
//     Residual
...
[b,stat]=linregr(yx,'y x','1 x x.^2','y')
deletefile('pontius_scl.txt')
diary('pontius_scl.txt')

mprintf('Dataset Pontius, quadratic, solved by linregr from Regress-Toolbox\n\n');
mprintf('            min.                   nom.                   max.                    delta\n');
for i=1:length(b)
    mprintf('b(%d)  %22.15e %22.15e %22.15e    %22.15e\n',i,b(i)-stat.bint(i),b(i),b(i)+stat.bint(i),stat.bint(i));
end

mprintf('\nR2 = %.12f\n',stat.R2);

printf('\n\nNIST reference solution: '); printf('%e ',Est);
