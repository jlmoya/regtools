...
funDef='b1 - b2*x1 .* exp(-b3*x2)'; 
dfunDef='[ones(x1),-b2*exp(-b3*x2),b2*(x1).*(x2).*exp(-b3*x2)]';
pDef='b1 b2 b3'; Names='y x1 x2';
deff('yhat=Nelson(b,x)','yhat=b(1) - b(2)*x1 .* exp(-b(3)*x2)');
//
//
//
...
//
bInit1=[2 0.0001 -0.01]';
bInit2=[2.5 0.000000005 -0.05]';
b=[2.5906836021E+00;5.6177717026E-09;-5.7701013174E-02];
resSS=3.7976833176E+00;
