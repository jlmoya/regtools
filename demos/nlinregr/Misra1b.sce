...
//
//               y = b1 * (1-(1+b2*x/2)**(-2))  +  e
funDef='b1 * (1-(1+b2*x/2).^(-2))'; 
dfunDef='[1-1.0./(b2*x/2+1).^2,b1*x./(b2*x/2+1).^3]';
pDef='b1 b2'; Names='y x';
deff('yhat=Misra1b(b,x)','yhat=b(1) * (1-(1+b(2)*x/2).^(-2))');
//
//
//
...
bInit1=[500 0.0001]';
bInit2=[300 0.0002]';
b=[3.3799746163E+02;3.9039091287E-04];
resSS=7.5464681533E-02;
