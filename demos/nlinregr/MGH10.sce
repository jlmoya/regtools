...
// 
//               y = b1 * exp[b2/(x+b3)]  +  e
funDef='b1 * exp(b2./(x+b3))'; 
dfunDef='[exp((b2)./(x+b3)),b1*exp((b2)./(x+b3))./(x+b3),-b1*b2*exp((b2)./(x+b3))./(x+b3).^2]';
pDef='b1 b2 b3'; Names='y x';
deff('yhat=MGH10(b,x)','yhat=b(1) * exp(b(2)./(x+b(3)))');
//
//
//
...
//
bInit1=[2 400000 25000]';
bInit2=[0.02 4000 250]';
b=[5.6096364710E-03;6.1813463463E+03;3.4522363462E+02];
resSS=8.7945855171E+01;
