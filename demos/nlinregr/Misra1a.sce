...
//               y = b1*(1-exp[-b2*x])  +  e
//
funDef='b1*(1-exp(-b2*x))'; pDef='b1 b2'; Names='y x';
dfunDef='[1-exp(-b2*x),b1*x.*exp(-b2*x)]';
deff('yhat=misrala(b,x)','yhat=b(1)*(1-exp(-b(2)*x))');
//
// 
...
bInit1=[500 .0001]';
bInit2=[250 .0005]';
b=[2.3894212918E+02; 5.5015643181E-04 ];
resSS=1.2455138894E-01;
//
