...
funDef='b1 + b2*exp(-x*b4) + b3*exp(-x*b5)';
dfunDef='[ones(x),exp(-x*b4),exp(-x*b5),-b2*x.*exp(-x*b4),-b3*x.*exp(-x*b5)]'; 
pDef='b1 b2 b3 b4 b5'; Names='y x';
deff('yhat=MGH17(b,x)','yhat=b(1) + b(2)*exp(-x*b(4)) + b(3)*exp(-x*b(5))');
//
//
//
...
//
bInit1=[50 150 -100 1 2]';
bInit2=[0.5 1.5 -1 0.01 0.02]';
b=[3.7541005211E-01;1.9358469127E+00;-1.4646871366E+00;1.2867534640E-02;2.2122699662E-02];
resSS=5.4648946975E-05;
