...
deff('yhat=Chwirut1(b,x)','yhat=exp(-b(1).*x)./(b(2)+b(3).*x)');
//
//
...
//
bInit1=[0.1 0.01 0.02]';
bInit2=[0.15 0.008 0.010]';
b=[1.9027818370E-01;6.1314004477E-03;1.0530908399E-02];
resSS=2.3844771393E+03;
