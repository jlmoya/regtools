...
funDef='b1*(x.^2+x*b2) ./ (x.^2+x*b3+b4)'; 
dfunDef='[(x.^2+b2*x)./(x.^2+b3*x+b4),b1*x./(x.^2+b3*x+b4),-b1*x.*(x.^2+b2*x)./(x.^2+b3*x+b4).^2,-b1*(x.^2+b2*x)./(x.^2+b3*x+b4).^2]';
pDef='b1 b2 b3 b4'; Names='y x';
deff('yhat=MGH09(b,x)','yhat=b(1)*(x.^2+x*b(2)) ./ (x.^2+x*b(3)+b(4))');
// 
//
// 
...
//
bInit1=[25 39 41.5 39]';
bInit2=[0.25 0.39 0.415 0.39]';
b=[1.9280693458E-01;1.9128232873E-01;1.2305650693E-01;1.3606233068E-01];
resSS=3.0750560385E-04;
