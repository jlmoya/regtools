...
//                   (1 + b4*x + b5*x**2)  +  e
//
funDef='(b1 + b2*x + b3*x.^2)./(1 + b4*x + b5*x.^2)'; 
dfunDef='[ones(x)./(b5*x.^2+b4*x+1),x./(b5*x.^2+b4*x+1),(x.^2)./(b5*x.^2+b4*x+1),-x.*(b3*x.^2+b2*x+b1)./(b5*x.^2+b4*x+1).^2,-(x.^2).*(b3*x.^2+b2*x+b1)./(b5*x.^2+b4*x+1).^2]';
pDef='b1 b2 b3 b4 b5'; Names='y x';
deff('yhat=Kirby2(b,x)','yhat=(b(1) + b(2)*x + b(3)*x.^2)./(1 + b(4)*x + b(5)*x.^2)');
// 
...
//
bInit1=[2 -0.1 0.003 -0.001 0.00001]';
bInit2=[1.5 -0.15 0.0025 -0.0015 0.00002]';
b=[1.6745063063E+00;-1.3927397867E-01;2.5961181191E-03;-1.7241811870E-03;2.1664802578E-05];
resSS=3.9050739624E+00;
