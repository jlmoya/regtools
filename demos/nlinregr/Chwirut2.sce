...
funDef='exp(-b1*x)./(b2+b3*x)'; pDef='b1 b2 b3'; Names='y x';
dfunDef='[-x.*exp(-b1*x)./(b3*x+b2),-exp(-b1*x)./(b3*x+b2).^2,-x.*exp(-b1*x)./(b3*x+b2).^2]';
deff('yhat=Chwirut2(b,x)','yhat=exp(-b(1).*x)./(b(2)+b(3).*x)');
//
//
//
...
bInit1=[.1 .01 .02]';
bInit2=[.15 .008 .010]';
b=[1.6657666537E-01; 5.1653291286E-03; 1.2150007096E-02];
resSS=5.1304802941E+02;
