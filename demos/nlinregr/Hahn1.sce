...
dfunDef='[1.0./(b7*x.^3+b6*x.^2+b5*x+1),x./(b7*x.^3+b6*x.^2+b5*x+1),(x.^2)./(b7*x.^3+b6*x.^2+b5*x+1),(x.^3)./(b7*x.^3+b6*x.^2+b5*x+1),-x.*(b4*x.^3+b3*x.^2+b2*x+b1)./(b7*x.^3+b6*x.^2+b5*x+1).^2,-(x.^2).*(b4*x.^3+b3*x.^2+b2*x+b1)./(b7*x.^3+b6*x.^2+b5*x+1).^2,-(x.^3).*(b4*x.^3+b3*x.^2+b2*x+b1)./(b7*x.^3+b6*x.^2+b5*x+1).^2]';
pDef='b1 b2 b3 b4 b5 b6 b7'; Names='y x';
deff('yhat=Hahn1(b,x)','yhat=(b(1)+b(2)*x+b(3)*x.^2+b(4)*x.^3)./(1+b(5)*x+b(6)*x.^2+b(7)*x.^3)');
//
//
...
//
bInit1=[10 -1 0.05 -0.00001 -0.05 0.001 -0.000001]';
bInit2=[1 -0.1 0.005 -0.000001 -0.005 0.0001 -0.0000001]';
b=[1.0776351733E+00;-1.2269296921E-01;4.0863750610E-03;-1.4262662514E-06;-5.7609940901E-03;2.4053735503E-04;-1.2314450199E-07];
resSS=1.5324382854E+00;
