...
//
//               y  = b1*x**b2  +  e
funDef='b1*x.^b2'; pDef='b1 b2'; Names='y x';
dfunDef='[b(x.^b2),b1*(x.^b2).*log(x)]';
deff('yhat=DanWood(b,x)','yhat=b(1)*x.^b(2)');
//
//
// 
...
bInit1=[1 5]';
bInit2=[.7 4]';
b=[7.6886226176E-01; 3.8604055871E+00];
resSS=4.3173084083E-03;
